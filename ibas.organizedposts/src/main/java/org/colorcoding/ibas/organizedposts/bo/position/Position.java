package org.colorcoding.ibas.organizedposts.bo.position;
...
@BusinessObjectUnit(code = Position.BUSINESS_OBJECT_CODE)
public class Position extends BusinessObject<Position> implements IPosition, IBOUserFields {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 515761242195773538L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = Position.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_OP_PSTN";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_OP_PSTN";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "Position";
