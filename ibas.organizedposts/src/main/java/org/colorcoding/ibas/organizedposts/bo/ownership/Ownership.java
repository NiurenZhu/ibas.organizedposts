...
public class Ownership extends BusinessObject<Ownership> implements IOwnership {
     ...
     * 序列化版本标记
     */
    private static final long serialVersionUID = 2653099589318915802L;
    ...
    * 属性名称-默认数据权限
    */
    private static final String PROPERTY_DEFAULTPERMISSION_NAME = "DefaultPermission";

    /**
    * 默认数据权限 属性
    */
    @DbField(name = "Permission", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME, primaryKey = false)
    public static final IPropertyInfo<emAuthoriseType> PROPERTY_DEFAULTPERMISSION = registerProperty(PROPERTY_DEFAULTPERMISSION_NAME, emAuthoriseType.class, MY_CLASS);
    ...
    * @return 值
    */
    @XmlElement(name = PROPERTY_DEFAULTPERMISSION_NAME)
    public final emAuthoriseType getDefaultPermission() {
        return this.getProperty(PROPERTY_DEFAULTPERMISSION);
    }
    ...
    * @param value 值
    */
    public final void setDefaultPermission(emAuthoriseType value) {
        this.setProperty(PROPERTY_DEFAULTPERMISSION, value);
    }
    ...
    * 属性名称-数据权限项
    */
    private static final String PROPERTY_OWNERSHIPITEMS_NAME = "OwnershipItems";

    /**
    * 数据权限项的集合属性
    * 
    */ 
    public static final IPropertyInfo<IOwnershipItems> PROPERTY_OWNERSHIPITEMS = registerProperty(PROPERTY_OWNERSHIPITEMS_NAME, IOwnershipItems.class, MY_CLASS);
    /**
    * 获取-数据权限项集合
    * 
    * @return 值
    */
    @XmlElementWrapper(name = PROPERTY_OWNERSHIPITEMS_NAME)
    @XmlElement(name = OwnershipItem.BUSINESS_OBJECT_NAME, type = OwnershipItem.class)
    public final IOwnershipItems getOwnershipItems() {
        return this.getProperty(PROPERTY_OWNERSHIPITEMS);
    }
    ...
    * @param value 值
    */
    public final void setOwnershipItems(IOwnershipItems value) {
        this.setProperty(PROPERTY_OWNERSHIPITEMS, value);
    }
    ...
    */
    ...
    protected void initialize() {
        ...
        this.setOwnershipItems(new OwnershipItems(this));
