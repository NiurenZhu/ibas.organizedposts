...
@XmlType(name = Post.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = Post.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BOCode(Post.BUSINESS_OBJECT_CODE)
public class Post extends BusinessObject<Post> implements IPost {

    /**
     * 序列化版本标记
     */
    private static final long serialVersionUID = -2265063614572280005L;

    /**
    * 当前类型
    */
    private static final Class<?> MY_CLASS = Post.class;

    /**
    * 数据库表
    */
    public static final String DB_TABLE_NAME = "${Company}_OP_POST";

    /**
    * 业务对象编码
    */
    public static final String BUSINESS_OBJECT_CODE = "${Company}_OP_POST";
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_POSTCODE = registerProperty(PROPERTY_POSTCODE_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_POSTNAME = registerProperty(PROPERTY_POSTNAME_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<Integer> PROPERTY_BELONGING = registerProperty(PROPERTY_BELONGING_NAME, Integer.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_POSITION = registerProperty(PROPERTY_POSITION_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_USERCODE = registerProperty(PROPERTY_USERCODE_NAME, String.class, MY_CLASS);
    ...
    */
     ...
     * 属性名称-下级岗位
     */
    private static final String PROPERTY_POSTS_NAME = "Posts";

    /**
     * 下级岗位的集合属性
     *
     */
    public static final IPropertyInfo<IPosts> PROPERTY_POSTS = registerProperty(PROPERTY_POSTS_NAME, IPosts.class, MY_CLASS);
    /**
     * 获取-下级岗位集合
     *
     * @return 值
     */
    @XmlElementWrapper(name = PROPERTY_POSTS_NAME)
    @XmlElement(name = Post.BUSINESS_OBJECT_NAME, type = Post.class)
    public final IPosts getPosts() {
        return this.getProperty(PROPERTY_POSTS);
    }
     ...
     * @param value 值
     */
    public final void setPosts(IPosts value) {
        this.setProperty(PROPERTY_POSTS, value);
    }
