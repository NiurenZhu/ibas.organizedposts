...
public class Post extends BusinessObject<Post> implements IPost, IBOUserFields {
	 ...
	 *
	 */
	public static final IPropertyInfo<IPosts> PROPERTY_POSTS = registerProperty(PROPERTY_POSTS_NAME, IPosts.class,
			MY_CLASS);
