...
/** 岗位 */
export class Post extends BOSimple<Post> implements IPost {
...
/** 岗位 集合 */
export class Posts extends BusinessObjects<Post, Post> implements IPosts {
    ...
    protected onParentPropertyChanged(name: string): void {
        ...
        if (strings.equalsIgnoreCase(name, Post.PROPERTY_INVALIDDATE_NAME)) {
            for (let item of this) {
