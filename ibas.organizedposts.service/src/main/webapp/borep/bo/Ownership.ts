...
namespace organizedposts {
    export namespace bo {
        ...
        /** 数据权限 */
        export class Ownership extends ibas.BOSimple<Ownership> implements IOwnership {
            ...
            /** 获取-默认数据权限 */
            get defaultPermission(): ibas.emAuthoriseType {
                return this.getProperty<ibas.emAuthoriseType>(Ownership.PROPERTY_DEFAULTPERMISSION_NAME);
            }
            /** 设置-默认数据权限 */
            set defaultPermission(value: ibas.emAuthoriseType) {
            ...
            get activated(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(Ownership.PROPERTY_ACTIVATED_NAME);
            }
            /** 设置-激活 */
            ...
            protected init(): void {
                ...
                this.objectCode = ibas.config.applyVariables(Ownership.BUSINESS_OBJECT_CODE);
        ...
        /** 数据权限项 集合 */
        export class OwnershipItems extends ibas.BusinessObjects<OwnershipItem, Ownership> implements IOwnershipItems {
        ...
        /** 数据权限项 */
        export class OwnershipItem extends ibas.BOSimpleLine<OwnershipItem> implements IOwnershipItem {
            ...
            /** 获取-数据权限 */
            get permission(): ibas.emAuthoriseType {
                return this.getProperty<ibas.emAuthoriseType>(OwnershipItem.PROPERTY_PERMISSION_NAME);
            }
            /** 设置-数据权限 */
            set permission(value: ibas.emAuthoriseType) {
