...
namespace organizedposts {
    export namespace app {
        ...
        export class OwnershipChooseApp extends ibas.BOChooseService<IOwnershipChooseView, bo.Ownership> {
            ...
            /** 应用标识 */
            static APPLICATION_ID: string = "8c3e1649-c105-44be-ad7e-726c4920733e";
            /** 应用名称 */
            static APPLICATION_NAME: string = "organizedposts_app_ownership_choose";
            /** 业务对象编码 */
        ...
        export class OwnershipChooseServiceMapping extends ibas.BOChooseServiceMapping {
            ...
            /** 创建服务并运行 */
            create(): ibas.IService<ibas.IBOChooseServiceCaller<bo.Ownership>> {
