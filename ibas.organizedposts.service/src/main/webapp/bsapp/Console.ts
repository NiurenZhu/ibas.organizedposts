    ...
    export namespace app {
        ...
        export class Console extends ibas.ModuleConsole {
            ...
            protected registers(): void {
                ...
                if (ibas.strings.equalsIgnoreCase(bo.CONFIG_VALUE_ORGANIZATION_WAY, ibas.config.get(ibas.CONFIG_ITEM_ORGANIZATION_WAY))) {
                    // 组织为本模块实现
            ...
            run(): void {
                // 加载语言-框架默认
                ibas.i18n.load([
                    this.rootUrl + "resources/languages/organizedposts.json",
